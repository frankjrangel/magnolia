	...
	<div id="footer">
      ...
      <div class="redes marrones">
        ...
        style="background-image:url(/magnolia/wp-content/themes/magnolia/assets/img/redes/twitter_logo.svg );">
        </a>
        <a href="<?php the_field('facebook', 30 );?>" target="_blank"
        style="background-image:url(/magnolia/wp-content/themes/magnolia/assets/img/redes/facebook_logo.svg );">
        </a>
        <a href="<?php the_field('instagram', 30 );?>" target="_blank"
        style="background-image:url(/magnolia/wp-content/themes/magnolia/assets/img/redes/instagram_logo.svg );">
        </a>
        <a href="<?php the_field('pinterest', 30 );?>" target="_blank"
        style="background-image:url(/magnolia/wp-content/themes/magnolia/assets/img/redes/pinterest_logo.svg );">
        </a>
      </div>
